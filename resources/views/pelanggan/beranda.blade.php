            ...
            <section class="overflow-hidden rounded-[36px] border border-gray-200 bg-white mb-14">
                ...
                <div class="grid lg:grid-cols-2 items-center">
                    ...
                    <div class="p-14">
                        ...
                        <h2 class="mt-8 text-6xl font-extrabold leading-tight text-gray-900">
                        ...
                        <p class="mt-8 text-lg leading-9 text-gray-500">

                            Temukan minuman terbaik berdasarkan
                            mood, aktivitas, dan selera kamu.
                    ...
                    {{-- RIGHT --}}
                    <div class="flex items-center justify-center bg-orange-50 h-full">

                        <div class="relative">

                            <div class="absolute inset-0 rounded-full bg-orange-200 blur-3xl opacity-40"></div>

                            <img

                                src="{{ asset('images/hero-coffee.png') }}"

                                alt="Coffee"

                                class="relative w-[420px] object-contain">
